 ...
 */
Object.defineProperty(exports, "__esModule", { value: true });
exports.NodeCG = exports.nodecg = void 0;
exports.nodecg = window.nodecg, exports.NodeCG = window.NodeCG;
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"8e148e68-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./src/App.vue?vue&type=template&id=7183e7d8&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_c('div',{staticClass:"font-weight-bold pb-1"},[_vm._v(" "+_vm._s(_vm.name)+" ")]),_c('div',{staticClass:"d-flex"},[_c('v-text-field',{ref:"ChannelEntry",attrs:{"label":"Enter Twitch Channel","hide-details":"","filled":"","spellcheck":false,"disabled":_vm.applying},on:{"keyup":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.override($event)},"focus":_vm.focusChannelEntry,"input":_vm.focusChannelEntry,"blur":_vm.unfocusChannelEntry},model:{value:(_vm.channelEntry),callback:function ($$v) {_vm.channelEntry=$$v},expression:"channelEntry"}}),_c('v-btn',{style:({ 'min-width': '0', 'margin-left': '5px' }),attrs:{"height":"56px","disabled":_vm.applying,"loading":_vm.applying},on:{"click":_vm.override}},[_c('v-icon',[_vm._v("mdi-check")])],1)],1),_c('v-switch',{staticClass:"ma-1",attrs:{"hide-details":"","label":"Low Latency","disabled":_vm.applying},on:{"change":_vm.changeLatency},model:{value:(_vm.lowLatency),callback:function ($$v) {_vm.lowLatency=$$v},expression:"lowLatency"}}),_c('div',{style:({ 'margin': '10px 0' })},[_c('span',{style:({ 'font-weight': 'bold' })},[_vm._v(" Currently Overridden: ")]),_vm._v(" "+_vm._s(_vm.overridden)+" ")]),_c('div',{staticClass:"d-flex"},[_c('v-btn',{style:({ 'min-width': '0', flex: '1' }),attrs:{"disabled":_vm.applying},on:{"click":_vm.restart}},[_c('v-icon',[_vm._v("mdi-refresh")]),_vm._v(" Restart ")],1),_c('v-btn',{style:({ 'min-width': '0', 'margin-left': '5px', flex: '1' }),attrs:{"disabled":_vm.applying},on:{"click":_vm.stop}},[_c('v-icon',[_vm._v("mdi-stop")]),_vm._v(" Stop ")],1)],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./src/App.vue?vue&type=template&id=7183e7d8&
...
framework_Vuetify.version = "2.4.1";
framework_Vuetify.config = {
  silent: false
};
//# sourceMappingURL=framework.js.map
// EXTERNAL MODULE: C:/Dev Stuff/GitHub Repos/esa-layouts-shared/browser_shared/nodecg.ts
var nodecg = __webpack_require__("1c67");
...
var Appvue_type_script_lang_ts_default_1 = /** @class */ (function (_super) {
    ...
    function default_1() {
        ...
        _this.channelEntry = '';
        _this.lowLatency = true;
        _this.applying = false;
        _this.channelEntryFocused = false;
        return _this;
    }
    default_1.prototype.onRestreamDataChanged = function (val) {
        var _a, _b, _c;
        if (!this.channelEntryFocused) {
            this.channelEntry = ((_a = val[this.index]) === null || _a === void 0 ? void 0 : _a.channel) || '';
        }
        this.lowLatency = (_c = (_b = val[this.index]) === null || _b === void 0 ? void 0 : _b.lowLatency) !== null && _c !== void 0 ? _c : true;
    };
    Object.defineProperty(default_1.prototype, "overridden", {
        get: function () {
    ...
    default_1.prototype.focusChannelEntry = function () {
        var _this = this;
        this.channelEntryFocused = true;
        window.clearTimeout(this.channelEntryFocusedTimeout);
        this.channelEntryFocusedTimeout = window.setTimeout(function () {
            _this.$refs.ChannelEntry.blur();
            _this.channelEntry = _this.restreamData[_this.index].channel || '';
        }, 5 * 1000);
    };
    default_1.prototype.unfocusChannelEntry = function () {
        this.channelEntryFocused = false;
        window.clearTimeout(this.channelEntryFocusedTimeout);
    };
    default_1.prototype.override = function () {
        var _this = this;
        this.applying = true;
        nodecg["nodecg"].sendMessage('restreamOverride', { index: this.index, channel: this.channelEntry })
            .finally(function () { _this.applying = false; });
    };
    default_1.prototype.changeLatency = function () {
        var _this = this;
        this.applying = true;
        nodecg["nodecg"].sendMessage('restreamOverride', { index: this.index, lowLatency: this.lowLatency })
            .finally(function () { _this.applying = false; });
    };
    default_1.prototype.restart = function () {
        var _this = this;
        this.applying = true;
        nodecg["nodecg"].sendMessage('restreamRestart', { index: this.index })
            .finally(function () { _this.applying = false; });
    };
    default_1.prototype.stop = function () {
        var _this = this;
        this.applying = true;
        nodecg["nodecg"].sendMessage('restreamStop', { index: this.index })
            .finally(function () { _this.applying = false; });
    };
    __decorate([
        Prop({ type: String, default: 'Stream 1' })
    ], default_1.prototype, "name", void 0);
    __decorate([
        Prop({ type: Number, default: 0 })
    ], default_1.prototype, "index", void 0);
    __decorate([
        Prop(Array)
    ], default_1.prototype, "restreamData", void 0);
    __decorate([
        Watch('restreamData', { immediate: true })
    ], default_1.prototype, "onRestreamDataChanged", null);
...
/* harmony default export */ var VSheet_VSheet = (mixins_mixins(binds_attrs, colorable, elevatable, measurable, roundable, themeable).extend({
  name: 'v-sheet',
  props: {
    outlined: Boolean,
    shaped: Boolean,
...
function registrable_provide(namespace, self = false) {
  return external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
...
/* harmony default export */ var VBtn_VBtn = (baseMixins.extend().extend({
  ...
  computed: {
    ...
    isElevated() {
      return Boolean(!this.icon && !this.text && !this.outlined && !this.depressed && !this.disabled && !this.plain && (this.elevation != null || Number(this.elevation) < 1));
    },
...
const validatable_baseMixins = mixins_mixins(colorable, inject('form'), themeable);
/* @vue/component */
...
/* harmony default export */ var selectable = (mixins_mixins(components_VInput, rippleable, comparable).extend({
  name: 'selectable',
  model: {
    prop: 'inputValue',
    event: 'change'
...
installComponents_default()(App_component, {VBtn: VBtn_VBtn,VIcon: components_VIcon_VIcon,VSwitch: VSwitch_VSwitch,VTextField: VTextField_VTextField})

// CONCATENATED MODULE: ./src/main.ts

/* harmony default export */ var src_main = (App);
